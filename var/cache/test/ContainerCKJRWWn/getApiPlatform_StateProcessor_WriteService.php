...
class getApiPlatform_StateProcessor_WriteService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['api_platform.state_processor.write'])) {
            return $container->privates['api_platform.state_processor.write'];
        }

        return $container->privates['api_platform.state_processor.write'] = new \ApiPlatform\State\Processor\WriteProcessor(NULL, $a);
    }
}
