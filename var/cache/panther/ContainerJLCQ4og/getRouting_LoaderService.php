...
class getRouting_LoaderService extends App_KernelPantherDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $e = new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('panther');

        $b->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($d, 'panther'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($d, 'panther'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($d, 'panther'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($d, 'panther'));
        $b->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($d, 'panther'));
