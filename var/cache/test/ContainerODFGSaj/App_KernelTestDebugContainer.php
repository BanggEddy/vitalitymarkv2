...
class App_KernelTestDebugContainer extends Container
{
    ...
    {
        return $container->privates['api_platform.openapi.serializer_context_builder'] = new \ApiPlatform\OpenApi\Serializer\SerializerContextBuilder(($container->privates['api_platform.serializer.context_builder.filter'] ?? self::getApiPlatform_Serializer_ContextBuilder_FilterService($container)));
    }
    ...
    protected static function getApiPlatform_StateProvider_AccessChecker_PostDeserialize_InnerService($container)
    {
        ...
        return $container->privates['api_platform.state_provider.access_checker.post_deserialize.inner'] = new \ApiPlatform\State\Provider\DeserializeProvider(NULL, $a, ($container->privates['api_platform.openapi.serializer_context_builder'] ?? self::getApiPlatform_Openapi_SerializerContextBuilderService($container)), ($container->services['translator'] ?? self::getTranslatorService($container)));
    }
    ...
    {
        return $container->privates['api_platform.state_provider.parameter.inner'] = new \ApiPlatform\State\Provider\ReadProvider(($container->privates['api_platform.state_provider.locator'] ?? self::getApiPlatform_StateProvider_LocatorService($container)), ($container->privates['api_platform.openapi.serializer_context_builder'] ?? self::getApiPlatform_Openapi_SerializerContextBuilderService($container)));
    }
    ...
    protected static function getDoctrine_Orm_ContainerRepositoryFactoryService($container)
    {
        return $container->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\PanierItemsRepository' => ['privates', 'App\\Repository\\PanierItemsRepository', 'getPanierItemsRepositoryService', true],
            ...
            'App\\Repository\\PanierItemsRepository' => '?',
    ...
    {
        $a = ($container->privates['lexik_jwt_authentication.api_platform.openapi.factory.inner'] ?? self::getLexikJwtAuthentication_ApiPlatform_Openapi_Factory_InnerService($container));
        ...
        return $container->privates['lexik_jwt_authentication.api_platform.openapi.factory'] = new \Lexik\Bundle\JWTAuthenticationBundle\OpenApi\OpenApiFactory($a, '/api/login_check', 'username', 'password');
    }
    ...
    protected static function getLexikJwtAuthentication_ApiPlatform_Openapi_Factory_InnerService($container)
    {
        ...
        $b = ($container->privates['api_platform.json_schema.backward_compatible_schema_factory'] ?? self::getApiPlatform_JsonSchema_BackwardCompatibleSchemaFactoryService($container));
    ...
    protected static function getTwig_Loader_NativeFilesystemService($container)
    {
        ...
        $instance->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'knplabs'.\DIRECTORY_SEPARATOR.'knp-paginator-bundle/templates'), '!KnpPaginator');
        $instance->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'victor-prdh'.\DIRECTORY_SEPARATOR.'recaptcha-bundle'.\DIRECTORY_SEPARATOR.'src/Resources/views'), 'Recaptcha');
        $instance->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'victor-prdh'.\DIRECTORY_SEPARATOR.'recaptcha-bundle'.\DIRECTORY_SEPARATOR.'src/Resources/views'), '!Recaptcha');
