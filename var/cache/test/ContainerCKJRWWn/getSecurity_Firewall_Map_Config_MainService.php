...
class getSecurity_Firewall_Map_Config_MainService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.firewall.map.config.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'App\\Security\\UserChecker', '.security.request_matcher.yy_ZK6T', true, false, 'security.user.provider.concrete.app_user_provider', 'main', 'App\\Security\\AuthAuthenticator', NULL, NULL, ['remember_me', 'App\\Security\\AuthAuthenticator'], NULL, ['path' => 'app_logout', 'enable_csrf' => NULL, 'csrf_token_id' => 'logout', 'csrf_parameter' => '_csrf_token', 'target' => '/', 'invalidate_session' => true, 'clear_site_data' => [], 'delete_cookies' => []]);
    }
}
