...
class getAuthAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Security\\AuthAuthenticator'])) {
            return $container->privates['App\\Security\\AuthAuthenticator'];
        }

        return $container->privates['App\\Security\\AuthAuthenticator'] = new \App\Security\AuthAuthenticator(($container->services['router'] ?? self::getRouterService($container)), ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), $a);
    }
}
