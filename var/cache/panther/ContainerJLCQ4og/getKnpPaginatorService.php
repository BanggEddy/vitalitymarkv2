...
class getKnpPaginatorService extends App_KernelPantherDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['knp_paginator'] = $container->createProxy('PaginatorProxyA874acb', static fn () => \PaginatorProxyA874acb::createLazyProxy(static fn () => self::do($container, false)));
        }
