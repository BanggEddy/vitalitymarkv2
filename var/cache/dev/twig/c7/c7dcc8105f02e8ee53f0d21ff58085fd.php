...
class __TwigTemplate_8eeb52f5f7580950754759159603e81b extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/adminproducts/edit.html.twig"));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["promo"]) {
                ...
                if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["promo"], "idproduct", [], "any", false, false, false, 19), "id", [], "any", false, false, false, 19) == CoreExtension::getAttribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 19))) {
                    ...
                    // line 31
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["promo"], "getPriceafterpromo", [], "any", false, false, false, 31), "html", null, true);
                    yield " €</p>
                        ";
                }
                // line 33
            ...
            yield "</p>
                    <a href=\"";
            // line 39
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_form_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 39)]), "html", null, true);
            yield "\" class=\"btn btn-details edit-button\">              
...
";
    ...
    {
        return array (  182 => 49,  166 => 39,  162 => 38,  157 => 37,  151 => 35,  148 => 34,  142 => 33,  137 => 31,  133 => 30,  127 => 28,  123 => 26,  117 => 24,  114 => 23,  111 => 22,  108 => 21,  105 => 20,  102 => 19,  97 => 18,  95 => 17,  91 => 16,  86 => 14,  82 => 12,  78 => 11,  69 => 4,  59 => 3,  36 => 1,);
    }
        ...
        <div class=\"col-md-3\">
            <div class=\"product-card\">
                ...
                <div class=\"product-details\">
                    ...
                    <a href=\"{{ path('app_admin_form_edit', {'id': product.id}) }}\" class=\"btn btn-details edit-button\">              
                        <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-pencil-square\" viewBox=\"0 0 16 16\">
                            <path d=\"M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z\"/>
                            <path fill-rule=\"evenodd\" d=\"M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z\"/>
                        </svg>
...
{% endblock %}
", "admin/adminproducts/edit.html.twig", "C:\\Users\\David\\Desktop\\vitalitysecond\\vitalitymarkv2\\templates\\admin\\adminproducts\\edit.html.twig");
    }
}
