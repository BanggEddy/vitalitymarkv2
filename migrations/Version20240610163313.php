 ...
 */
final class Version20240610163313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, panier_items_id INT DEFAULT NULL, iduser_id INT DEFAULT NULL, quantity INT NOT NULL, INDEX IDX_24CC0DF2F1F5A7F6 (panier_items_id), UNIQUE INDEX UNIQ_24CC0DF2786A81FB (iduser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE panier_items (id INT AUTO_INCREMENT NOT NULL, idproduct_id INT DEFAULT NULL, quantity INT DEFAULT NULL, INDEX IDX_C833C6F0882D7B60 (idproduct_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, idloyaltycard_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, civilite VARCHAR(255) DEFAULT NULL, date_create DATE NOT NULL, deleted_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', expired_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_8D93D64965FAB2BC (idloyaltycard_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64965FAB2BC FOREIGN KEY (idloyaltycard_id) REFERENCES loyalty_card (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D64965FAB2BC');
