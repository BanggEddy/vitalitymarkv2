 ...
 */
class getSecurity_Authenticator_Manager_MainService extends App_KernelPantherDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['App\\Security\\AuthAuthenticator'] ?? $container->load('getAuthAuthenticatorService'));
