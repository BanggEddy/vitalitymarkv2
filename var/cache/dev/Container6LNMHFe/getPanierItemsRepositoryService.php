 ...
 */
class getPanierItemsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PanierItemsRepository' shared autowired service.
     *
     * @return \App\Repository\PanierItemsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PanierItemsRepository.php';

        return $container->privates['App\\Repository\\PanierItemsRepository'] = new \App\Repository\PanierItemsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
