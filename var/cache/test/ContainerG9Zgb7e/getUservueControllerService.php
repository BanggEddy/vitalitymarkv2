...
class getUservueControllerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\UservueController'] = $instance = new \App\Controller\UservueController(($container->privates['App\\Service\\PromotionService'] ?? $container->load('getPromotionServiceService')), ($container->privates['App\\Service\\ProductCategorie'] ?? $container->load('getProductCategorieService')), ($container->privates['security.csrf.token_manager'] ?? $container->load('getSecurity_Csrf_TokenManagerService')), ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), ($container->privates['App\\Service\\PanierUser'] ??= new \App\Service\PanierUser()));
